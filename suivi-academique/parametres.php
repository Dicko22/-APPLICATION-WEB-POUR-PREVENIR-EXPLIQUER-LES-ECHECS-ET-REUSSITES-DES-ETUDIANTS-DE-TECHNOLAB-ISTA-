...
<main id="main-content">
    ...
    <div class="top-bar">
        <div class="top-bar-title">
            <h4><i class="fa-solid fa-gear" style="color:#4361ee; margin-right:8px;"></i>Paramètres</h4>
    ...
    <div style="
        ...
        <i class="fa-solid fa-gear" style="font-size:48px; color:#cbd5e1; margin-bottom:20px; display:block;"></i>
