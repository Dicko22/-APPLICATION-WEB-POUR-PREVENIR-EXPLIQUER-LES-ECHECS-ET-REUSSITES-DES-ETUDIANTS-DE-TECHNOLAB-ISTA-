...
<main id="main-content">
    ...
    <div class="top-bar">
        <div class="top-bar-title">
            <h4><i class="fa-solid fa-chalkboard-user" style="color:#4361ee; margin-right:8px;"></i>Professeurs</h4>
            <p>Gestion du corps enseignant</p>
        </div>
    </div>
    ...
    <div style="
        ...
        <i class="fa-solid fa-chalkboard-user" style="font-size:48px; color:#cbd5e1; margin-bottom:20px; display:block;"></i>
